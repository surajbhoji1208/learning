...
**********TRICKY Questions POINTS*************************
-if there is multiple then block with catch , catch will cathc the error and remaining execute as it is
-You didn’t return → next .then() gets undefined
                Promise.resolve()
                    .then(() => {
                    ...
                    //undefined
-Nested microtasks go to end of queue
